    ...
    def add_knowledge_with_vm(self, sent_batch, max_entities=config.MAX_ENTITIES, max_length=128):
        ...
        for split_sent in split_sent_batch:
            ...
            know_sent_batch.append(
                know_sent)  # know_sent such as ['[CLS]', '患', '者', '有', '青', '光', '眼', '高','眼','压', '，', '看', '不', '清', '。', '[SEP]'], 其中【高眼压】为知识库补充
...
if __name__ == '__main__':
    kgm = KnowledgeGraph(spo_files=['HowNet'])
    sent_batch = ["邦加岛的面积有多大？", "属于日本人或者美国的岛屿有哪些？"]
    info = kgm.add_knowledge_with_vm(sent_batch=sent_batch)
    print(info)
